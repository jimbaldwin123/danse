...
<TABLE width="700" border="0" cellpadding="0" cellspacing="0" bgcolor="#E0E0E0">
  <TR> 
    ...
    <TD colspan="2"><TABLE width="525" border="0" cellpadding="0" cellspacing="0">
        ...
        <TR> 
          <TD colspan="3" align="right" valign="top" bgcolor="#E0E0E0"><IMG src="/_images/investor_relations/pt_investor_relations.gif" width="450" height="35"><IMG src="/_images/pt_right_tab.gif" width="75" height="35"></TD>
        </TR>
        <TR> 
...
<TABLE width="450" border="0" cellspacing="0" cellpadding="0">
  <TR>
    <TD>Investor Relations contains information on MaxWorldwide's standing in the investment community. 
      <P>For more information on the company, or if you have questions pertaining 
        to investor relations, please contact:</P>
      <TABLE width="450" border="0" cellspacing="0" cellpadding="0">
        <TR> 
          <TD bgcolor="#ececec"></TD>
        </TR>
        <TR> 
          <TD height="20"  align="left" valign="middle" background="/_images/table_header_bg.gif"><SPAN class="caption_grey">&nbsp;</SPAN><B>&nbsp;INVESTOR 
            RELATIONS</B></TD>
        </TR>
        <TR> 
