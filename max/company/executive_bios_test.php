...
<TABLE width="700" border="0" cellpadding="0" cellspacing="0" bgcolor="#E0E0E0">
  <TR> 
    ...
    <TD colspan="2"><TABLE width="525" border="0" cellpadding="0" cellspacing="0">
        ...
        <TR> 
          <TD colspan="3" align="right" valign="top" bgcolor="#E0E0E0"><IMG src="/_images/company/pt_executive_bios.gif" width="450" height="35"><IMG src="/_images/pt_right_tab.gif" width="75" height="35"></TD>
        </TR>
        <TR> 
  ...
  <TR> 
    <TD width="524" valign="top"><TABLE width="524" border="0" cellspacing="0" cellpadding="10">
        <TR> 
          <TD width="10">&nbsp;</TD>
          <TD><? include $DOCUMENT_ROOT.'/company/executive_bios_test.inc'; ?></TD>
        </TR>
      </TABLE>
      <BR> <BR> </TD>
