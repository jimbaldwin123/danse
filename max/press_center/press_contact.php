...
<TABLE width="700" border="0" cellpadding="0" cellspacing="0" bgcolor="#E0E0E0">
  <TR>
    ...
    <TD colspan="2"><TABLE width="525" border="0" cellpadding="0" cellspacing="0">
        ...
        <TR>
          <TD colspan="3" align="right" valign="top" bgcolor="#E0E0E0"><IMG src="/_images/press_center/pt_press_contact.gif" width="450" height="35"><IMG src="/_images/pt_right_tab.gif" width="75" height="35"></TD>
        </TR>
        <TR>
        ...
        <TR align="left" valign="top">
          <TD width="33%"> <P><B>Cheryl Dubicki</B><BR>
            ...
            <P><IMG src="/_images/button_email.gif" width="12" height="12" align="absbottom">
              <A href="mailto:cdubicki@maxworldwide.com">cdubicki@maxworldwide.com</A></P>
          </TD>
        </TR>
      </TABLE></TD>
  </TR>
